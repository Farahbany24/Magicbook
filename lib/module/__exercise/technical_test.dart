...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      Map<String, int>? output;
      output = {
        "apple": input[0]["apple"] ?? 0, // Mengambil nilai dari map pertama
      };
      // --- End of Answer ---
...
// Mengembalikan output
    ...
    () {
      List<String> fruits = ["apple", "banana", "cherry"];
// Memeriksa apakah ada buah dengan nama "apple" pada List fruits
...
// Mengembalikan output
    ...
    () {
      List<String> fruits = ["apple", "banana", "cherry"];
// Menggabungkan semua elemen pada List fruits menjadi satu string dengan spasi
...
// Mengubah semua karakter pada variable text menjadi huruf kecil
...
// Mengembalikan hasil perbandingan
    ...
    () {
      String text = "dart is awesome";
// Mengubah semua karakter pada variable text menjadi huruf besar
...
// Mengembalikan hasil perbandingan
    ...
    () {
      String text = "Dart is awesome";
// Mengganti kata "awesome" dengan "fantastic"
...
// Mengembalikan hasil perbandingan
    ...
    () {
      String text = "Dart is awesome";
// Mengambil 11 karakter terakhir dari variable text
...
// Mengembalikan hasil
    ...
    () {
      String text = "Dart is awesome";
// Memeriksa apakah variable text diawali dengan kata "Dart"
...
// Mengembalikan hasil
    ...
    () {
      String text = "Dart,is,awesome";
// Memisahkan kalimat pada variable text berdasarkan tanda koma (",")
...
// Mengembalikan hasil
    ...
    () {
      String text = "Dart is awesome";
// Mengambil substring dari index 5 hingga 10
...
// Mengembalikan hasil
    ...
    () {
      ...
      for (String color in colors) {
        result += color; // Menambahkan setiap warna ke result
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int number in numbers) {
        sum += number; // Menambahkan setiap angka ke sum
      }
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int number in numbers) {
        product *= number; // Mengalikan setiap angka ke product
      }
      // --- End of Answer ---
...
// Menentukan produk favorit
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]['absentDays'] <= 2) {
          goodPerformers.add(employees[i]);
        }
      }
      // --- End of Answer ---
